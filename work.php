...
?>
        ...
        <main class="work-main-ctn">
            ...
            <section class="work-txt-ctn">   
                <h3>Work</h3>
                <p>Tiago usually works in pen and ink; however, he is also adept at using digital editing software to enhance illustration when necessary. His works are lively and impactful and range from character design, to portraits, to in-depth scenery illustration.</p>        
            </section>
            ...
            <p class="work-hdr"><a class="light-hover"  href="dailyblackhero2020.php">Daily Black Hero 2020</a></p>
                    <a href="dailyblackhero2020.php"  class="work-img-ctn">
                        ...
                        <div class="work-img daily-20-3"></div>
                    </a>
           ...
           <a href="dailyblackhero2019.php" class="work-img-ctn">
                        ...
                        <div class="work-img daily-19-2"></div>
                        <div class="work-img daily-19-3"></div>
</a>
            ...
            <div class="work-img-section-ctn">
                ...
                <a href="sensei-stamps.php" class="work-img-ctn">
                        ...
                        <div class="work-img Stamps-3"></div>
                    </a>
            </div>
